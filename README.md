...
Every chapter can also be listened to: about 27 minutes of narration in a synthetic voice (Kokoro-82M), one track per chapter. Press *Listen straight through* on the page. The scripts are in `narration/` and `tools/README.md` explains how the audio is made.
